...
$j=4;
for($i=$thang1;$i<=$thang2;$i++){
	$sheet 	-> setCellValue(getNameFromNumber($j).$dong, "=SUM(".getNameFromNumber($j)."7:".getNameFromNumber($j).($dong-1).")");		
